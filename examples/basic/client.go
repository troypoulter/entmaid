...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	if _, ok := c.driver.(*txDriver); ok {
		return nil, errors.New("basic: cannot start a transaction within a transaction")
	}
	tx, err := newTx(ctx, c.driver)
	if err != nil {
		return nil, fmt.Errorf("basic: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("basic: unknown mutation type %T", m)
	}
}
...
func (c *CarClient) mutate(ctx context.Context, m *CarMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("basic: unknown Car mutation op: %q", m.Op())
	}
}
...
func (c *GroupClient) mutate(ctx context.Context, m *GroupMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("basic: unknown Group mutation op: %q", m.Op())
	}
}
...
func (c *UserClient) mutate(ctx context.Context, m *UserMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("basic: unknown User mutation op: %q", m.Op())
	}
}
